...
| 1.D | LANDING 4, stage D: new file `instances/psl211/psl211_word_model.v`, its manifest row, the word proximity row, rewrite of the production comment of `psl211_alldecks_constancy_false_word584` | staged build and both audits done (`notes/probes/2026-09-20-tableau-extensions-landing4/`), fix pass 1 running; `psl211_word_lawE` becomes `psl211_word_law_le40` |
