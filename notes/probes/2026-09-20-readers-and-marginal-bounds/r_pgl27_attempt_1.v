...
Proof. by rewrite /= (pgl27_reading_of_trace C x g). Qed.
...
exact: (pgl27_view_indep R (C := C) HC).
Qed.
...
Proof. by move=> HC; exact: (pgl27_coalition_trace_secrecy R (C := C) HC). Qed.
...
exact: (pgl27_content_traceE C (u.1, @word_eval pgl27_Msym 200 u.2)).
Qed.
