...
not of the protocol alone, and for PSL(2,11) it is a property of the uniform
average over deal descriptions. What it does NOT show: that a hidden uniform
deal leaks. The deal in the refutation is a point mass, hence public.
...
sentences are the two `Require Import` lines, at 1.35 s and 1.25 s; no proof
sentence exceeds 0.7 s.
