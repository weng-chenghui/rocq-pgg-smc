...
(*                                                                            *)
(* One run reaches this level and three values name it. psl211_alldecks_prefix*)
(* is the one both published rows of the instance continue from, and it names *)
(* its termination proof. The other two write that proof a different way, and *)
(* they are here because the difference they make is a fact about the tree    *)
