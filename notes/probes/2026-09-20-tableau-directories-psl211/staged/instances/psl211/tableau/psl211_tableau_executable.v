...
(* argument is, who commits, what the dealer lays, what value the run is      *)
(* meant to recover and how much interpreter fuel it is allowed. The          *)
(* proposition is still True, so a reader shown this file has been shown      *)
(* which run is about to be made, and no proof that it terminates or that it  *)
...
(* deck, and the value the run recovers is the chirality bit. Both rows the   *)
(* manifest carries for this instance, psl211_row_alldecks and                *)
