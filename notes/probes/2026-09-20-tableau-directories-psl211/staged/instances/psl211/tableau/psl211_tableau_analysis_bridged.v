...
(* five of the twelve seats, each seat reading the card at its own position.  *)
(* The deck description, the whole run argument, is a chirality bit with a    *)
(* deal, and it is drawn uniformly: one of the two chiralities, one of the    *)
(* 132 block lines of that chirality's Steiner system for the six heart       *)
(* positions, one of the 720 labellings of the heart codes and one of the     *)
(* 720 labellings of the club codes.                                          *)
(*                                                                            *)
...
(*   psl211_row_word_proximity == the word row as a program, published at     *)
(*                              2^-40                                         *)
(*                                                                            *)
(* Key results:                                                               *)
