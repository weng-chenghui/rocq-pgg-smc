...
(* probe proved, modulo four name substitutions and one proof edit: the R7    *)
(* rename of pow2_40_ge1 and pow2_40_gt0 to pgl27_pow2_40_ge1 and             *)
(* pgl27_pow2_40_gt0, the renames of pgl27_row_word_arms_sampledE to          *)
(* pgl27_row_word_families_sampledE and of pgl27_word_uniform_ideal_not_close *)
(* to pgl27_word_uniform_ideal_close_false, and the replacement of the        *)
(* four-branch first [...] of var_dist_fdist1_uniform by the one branch that  *)
(* fires.  Each restatement is closed by exact: <staged name>, so a staged    *)
(* statement that drifted from the probe's fails here.                        *)
(*                                                                            *)
