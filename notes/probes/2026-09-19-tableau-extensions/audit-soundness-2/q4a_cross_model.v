(* Audit round 2, question 4: the recorded Fail pgl27_cross_model of
   t0_sampled_branch_pgl27.v, written without Fail so that the error can be
   read. *)
...
Definition q4a_cross_model : Tableau AnalysisBridged :=
