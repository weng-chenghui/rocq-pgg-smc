...
(** The claim this row carries, at every real field and index: independence of
    ...
    distance between two readings. Conversion decides it from the certify
    statement the program wrote. *)
Check (fun R idx =>
  (erefl : security_claim_of five_card_row_uniform_tableau R idx
