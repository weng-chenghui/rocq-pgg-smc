...
(** The claim this row carries, at every real field and index: independence of
    the coalition's view from the tape secret, and not a distance between two
    readings. Conversion decides it from the certify statement the program
    wrote. *)
Check (fun R idx =>
  (erefl : security_claim_of s5_row_rand_tableau R idx
