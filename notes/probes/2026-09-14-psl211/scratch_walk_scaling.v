(* scratch_walk_scaling: probe_mixing's walk, with extra L data points so the
   L = 570 cost can be extrapolated from a measured curve rather than one
   point.  L = 570 itself is deliberately NOT attempted here.
...
Local Lemma walk300_total : total (walkN 300) = N.pow 3 300.
Proof. by vm_compute. Qed.

Local Lemma walk400_total : total (walkN 400) = N.pow 3 400.
Proof. by vm_compute. Qed.
