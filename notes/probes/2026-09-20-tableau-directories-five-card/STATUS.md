...
| `five_card_tableau_algebraic.v` | 85 |
| `five_card_tableau_executable.v` | 89 |
| `five_card_tableau_observed.v` | 147 |
| `five_card_tableau_sampled.v` | 270 |
| `five_card_tableau_analysis_bridged.v` | 1207 |
| `five_card_tableau_checks.v` | 242 |

Production is 998 plus 594, so 1592 lines become 2209:
...
docstring differs BY DESIGN: five_card_row_s5_family
      ...
      first at word 13: prod 'above' staged 'named'
