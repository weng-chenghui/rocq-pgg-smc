...
(******************************************************************************)
(* pgl27_proximity: the reading and the distances the eight-card orbit        *)
(* instance's proximity certificate is built from                             *)
(*                                                                            *)
...
(* on the group. The bound is an upper bound on a sum of absolute differences *)
