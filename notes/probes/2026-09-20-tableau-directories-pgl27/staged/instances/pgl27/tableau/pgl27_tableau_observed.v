...
(******************************************************************************)
(* pgl27_tableau_observed: the eight-card orbit instance at the Observed      *)
(* level                                                                      *)
(*                                                                            *)
...
(*                                                                            *)
(* One run reaches this level and two values name it. pgl27_dealt is the one  *)
(* all seven published rows of the instance continue from, and it names its   *)
(* termination proof. pgl27_inline_dealt writes that proof a different way,   *)
(* and it is here because the difference it makes is a fact about the tree    *)
...
(* observed execution, and every value typed against the first, the           *)
(* instance's three model families before anything else, would have to be     *)
(* built again over it. The checks file records the two terms the kernel      *)
