...
Definition pgl27_exact_witness (R : realType) (idx : unit)
  ...
  @MkExactWitness R pgl27_algebra pgl27_dealt_params
    (amf_sample pgl27_exact_family R idx) (coalition_endpoint_reading pgl27_algebra) bool (pgl27_secret R)
    (fun C HC =>
       let H3 : (#|C| <= 3)%N := HC in
       (eq_ind_r
...
Lemma pgl27_exact_leak4 :
  ExactLeakAt 4 (tableau_at (pgl27_dealt sample pgl27_exact_family))
    (@exact_of_reading (tableau_at (pgl27_dealt sample pgl27_exact_family))
       (coalition_endpoint_reading pgl27_algebra) pgl27_exact_witness).
Proof.
...
Definition pgl27_word_cert (R : realType) (secretP : R.-fdist bool)
  ...
  @MkIndistinguishabilityCert R pgl27_algebra pgl27_dealt_params
    (amf_sample pgl27_word_family R secretP) (coalition_endpoint_reading pgl27_algebra)
...
Lemma pgl27_exact_bridge (R : realType) (q : StackAt AnalysisBridged)
    (Hq : q = tableau_at (pgl27_dealt
                         ...
                         ;;; certify_exact of (@exact_of_reading
            (tableau_at (pgl27_dealt ;;; sample_step of pgl27_exact_family))
            (coalition_endpoint_reading pgl27_algebra) pgl27_exact_witness))) :
...
Definition pgl27_prior_exact_witness (R : realType) (secretP : R.-fdist bool)
  : ExactWitness (amf_sample pgl27_prior_exact_family R secretP)
      (coalition_endpoint_reading pgl27_algebra) :=
  @MkExactWitness R pgl27_algebra pgl27_dealt_params
    (amf_sample pgl27_prior_exact_family R secretP) (coalition_endpoint_reading pgl27_algebra) bool (pgl27_secret R)
    (fun C HC =>
       let H3 : (#|C| <= 3)%N := HC in
       (eq_ind_r
