...
(* of psl211_profile.v gives this instance's own marginal bound. At two deck  *)
(* descriptions of one chirality, differing in the block line alone, the      *)
(* coalition of seats 0, 1 and 2 reads the group-uniform cut under two        *)
(* different laws, psl211_blockline1_law_neq, so the field asks for more than *)
(* the secret-independence this row claims and its failure is not leakage.    *)
