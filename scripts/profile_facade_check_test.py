...
CASES = [
 ...
 ('C9  duplicate profile',
  lambda f, u: f.__setitem__('pgg-smc/instances/s5/zz_dup.v',
     'Definition s5_profile : MonodromyProfile := @MkMonodromyProfile w.\n'), 2),
 ('C10 nested comment hides a declaration',
  lambda f, u: f.__setitem__('pgg-smc/instances/s5/rogue.v',
     '(* draft\n(* see below *)\n' + ROGUE % '' + 'end *)\n'), 0),
 ('C10b real declaration deleted, ghost in nested comment',
  lambda f, u: f.__setitem__('pgg-smc/instances/s5/s5_profile.v',
     '(* old\n(* note *)\nDefinition s5_profile : MonodromyProfile := @MkMonodromyProfile a.\nend *)\n'), 1),
