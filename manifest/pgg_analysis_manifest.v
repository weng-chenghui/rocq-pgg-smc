...
(* assumption status.                                                         *)
(*                                                                            *)
(* A path records no security arm. Which arm a published program carries is   *)
(* read off that program by security_property_of of manifest/pgg_tableau.v,   *)
(* so which arm a path carries is told from the certificate its table names   *)
...
(*                        pgl27_tableau_analysis_bridged.v in                 *)
(*                        instances/pgl27/tableau/, which identifies the      *)
...
(*                          pgl27_tableau_analysis_bridged.v in               *)
(*                          instances/pgl27/tableau/, whose independence      *)
...
(*                          psl211_tableau_analysis_bridged.v in              *)
(*                          instances/psl211/tableau/, whose number is 2^-40  *)
