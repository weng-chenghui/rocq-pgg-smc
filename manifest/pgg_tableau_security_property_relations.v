...
(* proposition to the ideal-proximity proposition at a constant below two,    *)
(* uniform in the proximity certificate. Refuting it needs a model whose      *)
(* coalition readings at any two run arguments stay within the constant the   *)
...
(* is the ideal-proximity proposition derived from an                         *)
