...
Hypothesis defN_g2 : N = #|F_g2|.

(* n'' such that n = n''.+2 = N = code length *)
Variable n''_g2 : nat.
Hypothesis def_n_g2 : n''_g2.+2 = N.
...
Hypothesis k_g2_gt0 : 0 < k_g2.
Hypothesis le_kn_g2 : k_g2 <= n_g2.
Hypothesis lt_gk_g2 : g_g2 < k_g2.        (* 2 < k, i.e., k >= 3 *)
Hypothesis lt_kgn_g2 : k_g2 + g_g2 < n_g2. (* k + 2 < n *)

(* Design distance m = k + g - 1 = k + 1 *)
Let m_deg_g2 := (k_g2 + g_g2 - 1)%N.
Let deg_f_g2 := (2 * g_g2 + 1)%N.

Hypothesis deg_f_le_g2 : deg_f_g2 <= m_deg_g2.  (* 5 <= k+1, i.e., k >= 4 *)
...
Hypothesis low_redundancy_g2 : n_g2 <= k_g2 + g_g2 + 1. (* n <= k + 3 *)
...
exact: (@hyp_goppa_wt_mdeg F_g2 g_g2 curve_poly_g2 curve_deg_g2
  ...
  pts_x_uniq_g2 deg_f_le_g2 k_g2 ev_g2 ev_g2_encode v Hv).
Qed.
...
Proof.
move=> S target HS.
exact: (hyp_priv_surj curve_deg_g2 pts_on_curve_g2 pts_x_uniq_g2 lt_kgn_g2 lt_gk_g2 erefl g2_dual_ev_encode target HS).
Qed.
...
Let ts2 : ThresholdScheme 'I_N 'I_N :=
  @ag_genus_scheme F_g2 n''_g2 k_g2 g_g2 ev_g2
    ev_g2_rank k_g2_gt0 le_kn_g2 lt_kgn_g2 goppa_g2_wt ag_g2_priv_surj
    N defN_g2.
...
Let ts2_gap : ts_T ts2 <= ts_k ts2 + 2 * g_g2 :=
  @ag_genus_gap F_g2 n''_g2 k_g2 g_g2 ev_g2
    ev_g2_rank k_g2_gt0 le_kn_g2 lt_gk_g2 lt_kgn_g2 goppa_g2_wt ag_g2_priv_surj
    low_redundancy_g2 N defN_g2.
