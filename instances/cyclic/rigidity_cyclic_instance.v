...
Hypothesis card_G_ncycle_gt1 : (1 < #|pgg_G R_ncycle|)%N.
...
Hypothesis defN : (pgg_N' R_ncycle).+1 = #|GF m' primeq|.
...
Definition ncycle_covering : CoveringScheme R_ncycle :=
  genus0_covering card_G_ncycle_gt1 qn an defN sigma_fix0 code_auto.
