...
(* coalition-view bound: pgl27_word_view_indistinguishability                 *)
(* (instances/pgl27/ pgl27_models.v), at the fixed length L = 200, remains the*)
(* statement about what a coalition of seats jointly sees. A coalition bound  *)
(* for every L would need mixing on the 336 group elements rather than on the *)
(* 8 card positions, and is not proved here.                                  *)
(*                                                                            *)
