...
(******************************************************************************)
(* pgl27_verifolio_analysis_bridged: the eight-card orbit instance at the       *)
...
From pgg_smc Require Import pgl27_verifolio_observed.
From pgg_smc Require Import pgl27_verifolio_sampled.
...
Lemma pgl27_exact_leak4 :
  ExactLeakAt 4 (verifolio_at (pgl27_dealt sample pgl27_exact_family))
    pgl27_exact_witness.
Proof.
...
Definition pgl27_word_restated (R : realType) (secretP : R.-fdist bool)
    : RestatedVerifolio (pgl27_word_target R) :=
  pgl27_dealt
    ;;; sample_step of pgl27_word_family
    ;;; certify_indistinguishability of pgl27_word_cert
...
Definition pgl27_exact_restated (R : realType)
    : RestatedVerifolio (pgl27_exact_target R) :=
  pgl27_dealt
    ;;; sample_step of pgl27_exact_family
    ;;; certify_exact of pgl27_exact_witness
...
Definition pgl27_prior_exact_published : Published :=
  pgl27_dealt
    ...
    certify ExactIndependence by pgl27_prior_exact_witness
    |> publish StaticExecutedOnly assuming BaselineClassicalOnly.
...
Definition pgl27_word_proximity_published : PublishedAt pgl27_bound39 :=
  pgl27_word_sampled
    ...
    |> conclude at pgl27_bound39 by (fun R idx => pgl27_word_proximity_le39 idx)
    |> publish IdealFinite assuming BaselineClassicalOnly.
...
(** Both programs over the word model read their analysis model family off the
    one named Verifolio Sampled value, so the pair differs in the security
...
Lemma pgl27_word_published_families_sampledE :
  ...
  = sp_f (verifolio_at pgl27_word_sampled)
...
Lemma pgl27_word_published_obs_sampledE :
  ...
  = sp_obs (verifolio_at pgl27_word_sampled)
