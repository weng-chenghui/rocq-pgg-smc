...
(******************************************************************************)
(* pgl27_verifolio_checks: the terms refused at the eight-card orbit instance   *)
(*                                                                            *)
...
From pgg_smc Require Import pgl27_verifolio_analysis_bridged.
...
Fail Definition pgl27_inline_reuse : Verifolio Sampled :=
...
Fail Definition pgl27_word_published39_unindexed : PublishedAt pgl27_bound39 :=
  pgl27_dealt
    ...
    |> conclude at pgl27_bound39 by (fun R => ssr_ext.eqW (pow2_split R))
...
Fail Definition pgl27_word_published41 : PublishedAt pgl27_bound41 :=
  pgl27_dealt
    sample  pgl27_word_family
    certify InputIndistinguishability by pgl27_word_cert
    |> conclude at pgl27_bound41 by (fun R _ => ssr_ext.eqW (pow2_split R))
    |> publish IdealFinite assuming BaselineClassicalOnly.
...
(** The word model's proximity certificate does not continue the exact model's
    ...
    that same secretP. *)
Fail Definition pgl27_cross_model_proximity : Verifolio AnalysisBridged :=
