...
(* instance supplies it supplies as a payload: in the supplied program, the   *)
(* algebra and the layout on the first two statements, the three run facts on *)
(* the third, the probability model on the fourth, and one security record on *)
(* the fifth. The security mathematics reaches the randomized row through     *)
(* that last payload alone, and through two named facts: s5_rand_static_obsE, *)
