...
(******************************************************************************)
(* s5_verifolio_sampled: the five-seat instance at the Sampled level            *)
(*                                                                            *)
...
(* one-seat marginal bound of manifest/pgg_verifolio_marginal_bounds.v: it      *)
...
From pgg_smc Require Import s5_verifolio_observed.
...
(** The supplied run under the uniform tape model, named at Sampled. The family
    ...
    apart. *)
Definition s5_rand_sampled : Verifolio Sampled :=
