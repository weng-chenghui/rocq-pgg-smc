...
(******************************************************************************)
(* s5_verifolio_observed: the five-seat instance at the Observed level          *)
(*                                                                            *)
...
From pgg_smc Require Import s5_verifolio_executable.
...
Definition s5_dealt : Verifolio Observed :=
  s5_algebra
    dealt   fuel 150
...
Lemma s5_dealt_path_observedE :
  ob_obs (verifolio_at s5_dealt) = ap_observed s5_det_path.
Proof. by []. Qed.
...
Definition s5_dealt_observed_published : PublishedObserved :=
  s5_dealt |> publish Observed assuming (AcceptsAxioms [:: AxS5GroupOrder]).
...
(** The path this program builds is the manifest's own deterministic path.
    ...
    rejection in s5_verifolio_checks.v shows. *)
...
(** The supplied run of the five-seat instance: the algebra, the
    ...
    coalition. *)
Definition s5_supplied : Verifolio Observed :=
  s5_algebra
...
Lemma s5_supplied_paramsE :
  projT1 (projT2 (verifolio_at s5_supplied)) = s5_supplied_params.
Proof. by []. Qed.
