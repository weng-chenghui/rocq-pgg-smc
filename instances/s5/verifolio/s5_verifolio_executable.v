...
(******************************************************************************)
(* s5_verifolio_executable: the five-seat instance at the Executable level      *)
(*                                                                            *)
...
From pgg_smc Require Import s5_verifolio_algebraic.
...
(** The dealer-dealt mode at the Executable level: the run argument is the
    ...
    out again. *)
Definition s5_dealt_executable : Verifolio Executable :=
...
Lemma s5_dealt_executable_paramsE :
  projT2 (verifolio_at s5_dealt_executable) = s5_dealt_params.
...
Definition s5_supplied_executable : Verifolio Executable :=
...
Lemma s5_supplied_executable_paramsE :
  projT2 (verifolio_at s5_supplied_executable) = s5_supplied_params.
Proof. exact: erefl. Qed.
