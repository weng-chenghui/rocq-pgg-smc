...
(* termination lemma, reported 17.15 GB.  Allow 17 GB on a 32 GB machine.     *)
(* The twelve-card, fourteen-process interpreter trace is what takes the      *)
(* time, not the fuel: the same reduction at fuel 380 measured 562 s and      *)
(* 343 s, a difference inside the noise.  The reduction is symbolic in the    *)
(* cut; were it enumerating the 479001600 permutations of twelve points, no   *)
(* per-element time would make it finish.                                     *)
(*                                                                            *)
