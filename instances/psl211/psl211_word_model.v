...
(******************************************************************************)
(* psl211_word_model: the 584-letter word model of the twelve-card instance   *)
(*                                                                            *)
...
(* and differ in the law of the cut alone: this file is the all-decks carrier *)
(* with that one coordinate's law replaced, and nothing else of the instance  *)
(* is restated here.                                                          *)
(*                                                                            *)
...
(*   psl211_wordP         == the law of the word model, decks times cuts      *)
