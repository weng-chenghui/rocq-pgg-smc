...
(* it carries the distance the proximity arm of this instance takes as its    *)
...
(*                                                                            *)
(* Six is the privacy threshold the derived profile declares, and the         *)
(* distance below is proved at every coalition of the twelve seats, the       *)
(* threshold entering the arm's proposition and not the distance.             *)
(*                                                                            *)
(* Key results:                                                               *)
