...
(******************************************************************************)
(* psl211_verifolio_dealt: two readings of the fixed-dealer colour model of the *)
...
Definition psl211_dealt_sampled : Verifolio Sampled :=
...
Lemma psl211_dealt_sampled_viewE :
  sampled_viewE_prop (sp_f (verifolio_at psl211_dealt_sampled)).
Proof. exact: (proj2 (verifolio_thm psl211_dealt_sampled)). Qed.
...
Definition psl211_dealt_obstruction
  : ObstructionPayload (verifolio_at psl211_dealt_sampled) :=
  input_distinguishability_obstruction (verifolio_at psl211_dealt_sampled)
