...
(******************************************************************************)
(* psl211_verifolio_observed: the twelve-card instance at the Observed level    *)
(*                                                                            *)
...
From pgg_smc Require Import psl211_verifolio_executable.
...
Definition psl211_alldecks_prefix : Verifolio Observed :=
  psl211_algebra
...
Definition psl211_alldecks_prefix_vm : Verifolio Observed :=
  psl211_algebra
    supplied inputs psl211_inputT
             layout psl211_alldecks_layout
             expecting psl211_alldecks_expected
...
Lemma psl211_alldecks_prefix_vm_paramsE :
  projT1 (projT2 (verifolio_at psl211_alldecks_prefix_vm))
...
Definition psl211_alldecks_prefix_lit : Verifolio Observed :=
  psl211_algebra
    supplied inputs psl211_inputT
             layout psl211_alldecks_layout
             expecting psl211_alldecks_expected
...
Lemma psl211_alldecks_prefix_lit_paramsE :
  projT1 (projT2 (verifolio_at psl211_alldecks_prefix_lit))
  = psl211_alldecks_params.
Proof. by []. Qed.
