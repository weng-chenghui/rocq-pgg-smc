...
(******************************************************************************)
(* psl211_verifolio_executable: the twelve-card instance at the Executable      *)
(*                            level                                           *)
(*                                                                            *)
...
(* programs of psl211_verifolio_dealt.v continue from it and publish those      *)
...
From pgg_smc Require Import psl211_verifolio_algebraic.
...
Definition psl211_alldecks_executable : Verifolio Executable :=
...
Lemma psl211_alldecks_executable_paramsE :
  projT2 (verifolio_at psl211_alldecks_executable) = psl211_alldecks_params.
