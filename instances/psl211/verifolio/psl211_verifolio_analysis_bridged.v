...
(******************************************************************************)
(* psl211_verifolio_analysis_bridged: the twelve-card instance at               *)
(*                                  AnalysisBridged                           *)
(*                                                                            *)
...
(* equation, psl211_verifolio_sampled for a named model,                        *)
(* psl211_verifolio_observed for a run prefix, and psl211_verifolio_executable    *)
...
From pgg_smc Require Import psl211_verifolio_observed psl211_verifolio_sampled.
...
Definition psl211_alldecks_published : Published :=
  psl211_alldecks_prefix
    ...
    certify ExactIndependence by psl211_exact_witness
...
(** psl211_alldecks_number — the number the all-decks model is input
...
Definition psl211_alldecks_obstruction
  : ObstructionPayload (verifolio_at psl211_exact_sampled) :=
...
(** psl211_alldecks_obstruction_published — the all-decks run, the exact model
    ...
    manifest/pgg_verifolio.v that names one takes a PublishedAt, a different
    inductive type.
