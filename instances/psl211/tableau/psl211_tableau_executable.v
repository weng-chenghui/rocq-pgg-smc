...
(* deck, and the value the run is meant to recover is the chirality bit. Both *)
(* paths the manifest carries for this instance, psl211_alldecks_path and     *)
(* psl211_word_path, are over this one run, and they part at the model.       *)
(*                                                                            *)
