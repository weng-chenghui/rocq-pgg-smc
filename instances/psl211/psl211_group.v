...
(*                                                                            *)
(* The group generated by the two letters acts 2-transitively on the twelve   *)
(* positions, certified here by a nat-level word search over the 132 ordered  *)
(* distinct pairs. The enumeration of that group, its permutation tables and  *)
(* its order are in psl211_closure.v, which reads this file.                  *)
(*                                                                            *)
(* Definitions:                                                               *)
...
(*   psl211_wgenn i == the nat-level action of letter i on a position         *)
(*   psl211_papply w a == the position a word carries a to                    *)
...
(*   psl211_gens_in_G   == each letter lies in the group it generates         *)
...
(*                         in the group and acts as the nat-level word does   *)
...
Lemma psl211_r4_permVE (x : 'I_12) :
  val ((psl211_r4_perm^-1)%g x) = nth 0 psl211_r4_tbl (val x).
Proof.
have K : cancel (tbl_fun psl211_r4_tbl) (tbl_fun psl211_r4_tbl).
  by move=> y; apply: val_inj;
     case: y => -[|[|[|[|[|[|[|[|[|[|[|[|?]]]]]]]]]]]] ?.
have -> : (psl211_r4_perm^-1)%g x = tbl_fun psl211_r4_tbl x.
  by apply: (perm_inj (s := psl211_r4_perm)); rewrite permKV permE K.
by rewrite /tbl_fun /Imod /=;
   case: x => -[|[|[|[|[|[|[|[|[|[|[|[|?]]]]]]]]]]]] ?.
Qed.
