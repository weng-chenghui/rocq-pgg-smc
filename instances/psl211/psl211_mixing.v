...
(*                                                                            *)
(* The realistic word shuffle draws letters from the inverse-closed three-    *)
(* letter alphabet of psl211_closure.v: reversal of the three four-position   *)
(* segments, the half-Monge shuffle, and the inverse of the half-Monge        *)
(* shuffle. Its state space is the 660-element shuffle group that             *)
(* psl211_closure.v enumerates as permutation tables of 'I_12. A binary-N     *)
(* walk of length L = 584 tabulates how many letter words carry the identity  *)
(* to each of the 660 states, and a scalar checker certifies the total-       *)
(* variation bound those counts satisfy. Everything after that single kernel  *)
(* computation is exact rewriting.                                            *)
(*                                                                            *)
(* Definitions:                                                               *)
