...
(* about them are in instances/kim2025/verifolio/, whose AnalysisBridged file   *)
(* requires this one. This file requires no verifolio module, so the arrow      *)
(* between the mathematics and the verifolio runs one way, upward.              *)
(*                                                                            *)
(* Key results:                                                               *)
