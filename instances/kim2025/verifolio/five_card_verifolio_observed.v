...
(******************************************************************************)
(* five_card_verifolio_observed: the five-card instance at the Observed level   *)
(*                                                                            *)
...
From pgg_smc Require Import five_card_verifolio_executable.
...
Definition five_card_committed : Verifolio Observed :=
...
Lemma five_card_committed_paramsE :
  projT1 (projT2 (verifolio_at five_card_committed)) = five_card_params.
Proof. by []. Qed.
