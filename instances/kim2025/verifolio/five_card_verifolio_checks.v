...
(******************************************************************************)
(* five_card_verifolio_checks: the terms the kernel refuses at the five-card    *)
(* instance                                                                   *)
(*                                                                            *)
...
From pgg_smc Require Import five_card_verifolio_analysis_bridged.
...
Fail Definition five_card_s5_family_sampled : Verifolio Sampled :=
  five_card_committed
...
Fail Definition five_card_biased_sampled_at_manifest_level
  : Verifolio (ap_completion five_card_biased_path) :=
...
(** The same rejection where it is written in a program: the seven-cut
    ...
    certificate. *)
Fail Definition five_card_repeated_proximity : Verifolio AnalysisBridged :=
