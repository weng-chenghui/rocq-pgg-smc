...
(******************************************************************************)
(* five_card_verifolio_sampled: the five-card instance at the Sampled level     *)
(*                                                                            *)
...
(* in five_card_verifolio_analysis_bridged.v.                                   *)
(*                                                                            *)
...
(* one-position marginal bound of manifest/pgg_verifolio_marginal_bounds.v,     *)
...
(* five_card_verifolio_analysis_bridged.v, and the ascription of the one-cut    *)
(* Sampled program at the manifest's level is refused in                      *)
(* five_card_verifolio_checks.v.                                                *)
(*                                                                            *)
(* Definitions:                                                               *)
...
From pgg_smc Require Import pgg_verifolio_marginal_bounds.
...
(** The committed run under the uniform rotation, named at Sampled. The
    ...
    ideal. *)
Definition five_card_uniform_sampled : Verifolio Sampled :=
  five_card_committed
...
Definition five_card_repeated_sampled : Verifolio Sampled :=
  five_card_committed
...
Definition five_card_biased_sampled : Verifolio Sampled :=
  five_card_committed
...
Lemma five_card_repeated_sampled_prefixE :
  [/\ projT1 (verifolio_at five_card_repeated_sampled)
      = projT1 (verifolio_at five_card_committed),
      projT1 (projT2 (verifolio_at five_card_repeated_sampled))
      = projT1 (projT2 (verifolio_at five_card_committed))
    & sp_obs (verifolio_at five_card_repeated_sampled)
      = ob_obs (verifolio_at five_card_committed)].
Proof. by split. Qed.

(** The same for the biased program. *)
Lemma five_card_biased_sampled_prefixE :
  [/\ projT1 (verifolio_at five_card_biased_sampled)
      = projT1 (verifolio_at five_card_committed),
      projT1 (projT2 (verifolio_at five_card_biased_sampled))
      = projT1 (projT2 (verifolio_at five_card_committed))
    & sp_obs (verifolio_at five_card_biased_sampled)
      = ob_obs (verifolio_at five_card_committed)].
Proof. by split. Qed.
...
Lemma five_card_repeated_sampled_modelE :
  sp_f (verifolio_at five_card_repeated_sampled)
...
Lemma five_card_biased_sampled_modelE :
  sp_f (verifolio_at five_card_biased_sampled)
...
(** The manifest's completion level for the biased path is AnalysisBridged.
    ...
    rejected ascription of five_card_verifolio_checks.v are the two halves of
