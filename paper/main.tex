...
We introduce \pgg (\textit{Parametric Group Game}), a framework extending Diaconis's shuffle fairness to $k$-coalition resistance.
...
Our contribution, formalized in \Rocq, is the \pgg framework — \textit{Parametric Group Game} — which extends Diaconis's spectral fairness analysis to $k$-coalition resistance.
